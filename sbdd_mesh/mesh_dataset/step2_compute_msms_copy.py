...
def compute_msms(data_root, gdb_id, msms_bin):
    ...
    mesh_file = os.path.join("/mnt/workspace/dlly/targetdiff_mesh/mesh_dataset/data", f'{xyz_file_name}_msms.npz')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-root', type=str, default='/mnt/data/oss_beijing/mesh/targetdiff_mesh/data/crossdocked_pocket10_mesh5')
